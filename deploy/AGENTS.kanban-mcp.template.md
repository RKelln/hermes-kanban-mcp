...
- **Commits**: end every message with `Generated By: <modelname>`; never commit under a human's git identity.
- **Ask before deploy/publish** — block with `ticket_block(reason="approval-required: ...")` and wait.
