...
#   6. tools/list exposes all 10 kanban tools.
...
# --- 6. tools/list exposes all 10 kanban tools -----------------------------------
echo "check 6/7: tools/list exposes all 10 kanban tools"
...
echo "  ok: all 10 tools present (board_list, ticket_list, ticket_get, ticket_events, ticket_claim, ticket_comment, ticket_complete, ticket_block, ticket_create, kanban_help)"
